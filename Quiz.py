...
def check_answer():
    ...
    check_botton.config(state=tkr.DISABLED)
...
def next_question():
    ...
    if i < len(questions):
        ...
        l2.config(text="")
        check_botton.config(state=tkr.NORMAL)
...
def write_result(answer, status):
    f=open("resultswithQuestions.txt", "a")
...
questions_file = "/Users/Anand/Downloads/Projects/Quiz-App-with-Email-Feature/questions.txt"
results_file = "/Users/Anand/Downloads/Projects/Quiz-App-with-Email-Feature/results.txt"

# Usage example
sender_email = 'kumaranand15122001@gmail.com'
sender_password = 'ymaohzupzwsjabjj'
recipient_email = 'meetakash1111198@gmail.com'
...
check_botton = tkr.Button(root, text="Check", command=check_answer)
check_botton.configure(bg="light blue")
check_botton.pack()
